...
`,gt={...l,Layout(){return p(l.Layout,null,{"home-features-after":()=>p(vt,{allContributors:JSON.parse(ft)})})},enhanceApp(t){l.enhanceApp(t),t.app.component("ClickToIFrame",nt)}};function C(t){if(t.extends){const n=C(t.extends);return{...n,...t,async enhanceApp(e){n.enhanceApp&&await n.enhanceApp(e),t.enhanceApp&&await t.enhanceApp(e)}}}return t}const i=C(gt),bt=I({name:"VitePressApp",setup(){const{site:t}=T();return E(()=>{M(()=>{document.documentElement.lang=t.value.lang,document.documentElement.dir=t.value.dir})}),R(),D(),F(),i.setup&&i.setup(),()=>p(i.Layout)}});async function Ct(){const t=wt(),n=yt();n.provide(O,t);const e=N(t.route);return n.provide(V,e),n.component("Content",B),n.component("ClientOnly",H),Object.defineProperties(n.config.globalProperties,{$frontmatter:{get(){return e.frontmatter.value}},$params:{get(){return e.page.value.params}}}),i.enhanceApp&&await i.enhanceApp({app:n,router:t,siteData:J}),{app:n,router:t,data:e}}function yt(){return z(bt)}function wt(){let t=d,n;return G(e=>{let o=Z(e);return t&&(n=o),(t||n===o)&&(o=o.replace(/\.js$/,".lean.js")),d&&(t=!1),K(()=>import(o),[])},i.NotFound)}d&&Ct().then(({app:t,router:n,data:e})=>{n.go().then(()=>{j(n.route,e.site),t.mount("#app")})});export{Ct as createApp};
